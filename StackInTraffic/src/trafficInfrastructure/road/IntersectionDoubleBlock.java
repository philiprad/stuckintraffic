...
public class IntersectionDoubleBlock {
	...
	public static ArrayList<PathPoint> getLeft2To1BottomPath(int x, int y, short blockType){
		...
		ArrayList<PathPoint> arrPathPoints = new ArrayList<PathPoint>();
		for (int i = 0; i < GraphicsConfig.DISTANCE_BETWEEN_LANES; i++){
			arrPathPoints.add(new PathPoint(blockType, x+i, y+GraphicsConfig.CAR_POSITION_DOUBLE_LANE+GraphicsConfig.DISTANCE_BETWEEN_LANES, RoadConfig.LEFT_2_TO_BOTTOM_1_DIRECTION, 90 ));
		}
		x+=GraphicsConfig.DISTANCE_BETWEEN_LANES;
		y+=GraphicsConfig.BLOCK_SIDE_SIZE*2;
		float theta = 270;
	...
	public static ArrayList<PathPoint> getRight2To1TopPath(int x, int y, short blockType){
		ArrayList<PathPoint> arrPathPoints = new ArrayList<PathPoint>();
		for (int i = 0; i < GraphicsConfig.DISTANCE_BETWEEN_LANES; i++){
			arrPathPoints.add(new PathPoint(blockType, x+GraphicsConfig.BLOCK_SIDE_SIZE*2-i, y+GraphicsConfig.CAR_INVERSE_POSITION_DOUBLE_LANE - GraphicsConfig.DISTANCE_BETWEEN_LANES,RoadConfig.RIGHT_2_TO_TOP_1_DIRECTION, 270 ));
		}
		x+=GraphicsConfig.BLOCK_SIDE_SIZE*2-GraphicsConfig.DISTANCE_BETWEEN_LANES;
	...
	public static ArrayList<PathPoint> getRight1To2BottomPath(int x, int y, short blockType){
		ArrayList<PathPoint> arrPathPoints = new ArrayList<PathPoint>();
		for (int i = 0; i < GraphicsConfig.DISTANCE_BETWEEN_LANES; i++){
			arrPathPoints.add(new PathPoint(blockType, x+GraphicsConfig.BLOCK_SIDE_SIZE*2-i, y+GraphicsConfig.CAR_INVERSE_POSITION_DOUBLE_LANE,RoadConfig.RIGHT_1_TO_BOTTOM_2_DIRECTION, 270 ));
		}
		y+=GraphicsConfig.BLOCK_SIDE_SIZE*2;
		x+=GraphicsConfig.BLOCK_SIDE_SIZE*2-GraphicsConfig.DISTANCE_BETWEEN_LANES;
		float theta = 270;
	...
	public static ArrayList<PathPoint> getTop1To2RightPath(int x, int y, short blockType){
		ArrayList<PathPoint> arrPathPoints = new ArrayList<PathPoint>();
		for (int i = 0; i < GraphicsConfig.DISTANCE_BETWEEN_LANES; i++){
			arrPathPoints.add(new PathPoint(blockType,x+GraphicsConfig.CAR_INVERSE_POSITION_DOUBLE_LANE , y+i,RoadConfig.TOP_1_TO_RIGHT_2_DIRECTION, -1 ));
		}
		x+=GraphicsConfig.BLOCK_SIDE_SIZE*2;
	...
	public static ArrayList<PathPoint> getTop2To1LeftPath(int x, int y, short blockType){
		ArrayList<PathPoint> arrPathPoints = new ArrayList<PathPoint>();
		for (int i = 0; i < GraphicsConfig.DISTANCE_BETWEEN_LANES; i++){
			arrPathPoints.add(new PathPoint(blockType,x+GraphicsConfig.CAR_INVERSE_POSITION_DOUBLE_LANE-GraphicsConfig.DISTANCE_BETWEEN_LANES, y+i,RoadConfig.TOP_2_TO_LEFT_1_DIRECTION, -1 ));
		}
		y+=GraphicsConfig.DISTANCE_BETWEEN_LANES;
		float theta = 0;
		int radius = GraphicsConfig.CAR_INVERSE_POSITION_DOUBLE_LANE - GraphicsConfig.DISTANCE_BETWEEN_LANES;
	...
	public static ArrayList<PathPoint> getBottom2To1RightPath(int x, int y, short blockType){
		ArrayList<PathPoint> arrPathPoints = new ArrayList<PathPoint>();
		for (int i = 0; i < GraphicsConfig.DISTANCE_BETWEEN_LANES; i++){
			arrPathPoints.add(new PathPoint(blockType,x+GraphicsConfig.CAR_POSITION_DOUBLE_LANE+GraphicsConfig.DISTANCE_BETWEEN_LANES , y+GraphicsConfig.BLOCK_SIDE_SIZE*2-i, RoadConfig.BOTTOM_2_TO_RIGHT_1_DIRECTION ,-1 ));
		}
		x+=GraphicsConfig.BLOCK_SIDE_SIZE*2;
